...
class ffffoundProxy extends proxy {
	...
	public function load(){
		...
		$library = simplexml_load_file("http://feeds.feedburner.com/ffffound/everyone");
		  foreach ($library->channel->item as $entry) {
			  ...
			  //$str =$str.  "<description>".$entry->description."</description>\n";
				...
				$str =$str.  "<author><a href=\"".$entry->link."\">".$entry->author."</a></author>\n";
